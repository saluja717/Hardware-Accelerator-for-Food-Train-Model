...
void k2c_global_avg_pooling(size_t output_shape[],size_t output_numel, float output_array[], 
	const size_t input_shape[],const size_t input_ndim, size_t input_numel,float input_array[]);
